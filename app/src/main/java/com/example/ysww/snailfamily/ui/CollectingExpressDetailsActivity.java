...
public class CollectingExpressDetailsActivity extends AutoLayoutActivity implements HistoicFlowView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collecting_express_details);
