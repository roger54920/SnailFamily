...
import com.example.ysww.snailfamily.dialog.CollectingExceedTimeDialog;
 ...
 * 超期包裹延期缴费
 */
public class CollectingExceedTimeActivity extends AutoLayoutActivity implements HistoicFlowView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collecting_exceed_time);
    ...
    public void showAlertDialog() {
        CollectingExceedTimeDialog.Builder builder = new CollectingExceedTimeDialog.Builder(this);
