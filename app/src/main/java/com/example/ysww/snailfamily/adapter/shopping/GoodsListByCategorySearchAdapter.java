...
public class GoodsListByCategorySearchAdapter extends RecyclerView.Adapter implements AddReduceGoodsView {
    ...
    public GoodsListByCategorySearchAdapter(Activity context, List<GoodsListByCategoryBean.ListBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.commodity_search_result_list_item, null, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        RequestOperationUtil.setGlide(mContext, Constants.UP_LOAD_IMAGE_TOP + listBean.getNarrowViewUrl(), goodsListByCategoryItemViewHolder.itemImg);
