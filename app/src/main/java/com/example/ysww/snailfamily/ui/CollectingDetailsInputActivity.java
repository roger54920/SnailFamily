 ...
 * 代付快递详情 输入代付金额
 */
public class CollectingDetailsInputActivity extends AutoLayoutActivity implements HistoicFlowView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collecting_details_input);
