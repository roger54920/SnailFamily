 ...
 * 自定义弹窗 聊天退回原因
 */
public class CollectingCustomDialog extends Dialog {

	public CollectingCustomDialog(Context context) {
		super(context);
	}

	public CollectingCustomDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CollectingCustomDialog create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final CollectingCustomDialog dialog = new CollectingCustomDialog(context, R.style.Dialog);
			View layout = inflater.inflate(R.layout.coverpopup_collecting_cause_item, null);
